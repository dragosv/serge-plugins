...
Serge::Sync::Plugin::TranslationService::transifex - L<Transifex|https://www.transifex.com> synchronization plugin for L<Serge|https://serge.io/>
...
Uses the command-line tool for the Transifex API. See L<Transifex CLI|https://docs.transifex.com/client/introduction>.
