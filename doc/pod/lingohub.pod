...
Serge::Sync::Plugin::TranslationService::lingohub - L<Lingohub|https://www.lingohub.com> synchronization plugin for L<Serge|https://serge.io/>
...
Uses the command-line tool for the LingoHub API. See L<LingoHub CLI|https://github.com/lingohub/lingohub_ruby>.
