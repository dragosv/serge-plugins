...
Serge::Sync::Plugin::TranslationService::lokalise - L<Lokalise|https://lokalise.co> synchronization plugin for L<Serge|https://serge.io/> based on L<Lokalise CLI|https://docs.lokalise.co/api-and-cli/lokalise-cli-tool>
...
Transifex CLI resources directory.
...
This software is copyright (c) 2019 by Dragos Varovici.
