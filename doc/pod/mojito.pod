...
Serge::Sync::Plugin::TranslationService::mojito - L<Mojito|http://www.mojito.global/> synchronization plugin for L<Serge|https://serge.io/>
...
Uses the command-line tool for the Mojito API. See L<Mojito CLI|http://www.mojito.global/docs/guides/install/>.
