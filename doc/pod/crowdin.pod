...
Serge::Sync::Plugin::TranslationService::crowdin - L<Crowdin|https://crowdin.com> synchronization plugin for L<Serge|https://serge.io/>
...
Uses the command-line client for the Crowdin API (version 2). See L<Crowdin CLI|https://support.crowdin.com/cli-tool/>.
