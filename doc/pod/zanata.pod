...
Serge::Sync::Plugin::TranslationService::zanata - L<Zanata|http://zanata.org/> synchronization plugin for L<Serge|https://serge.io/>
...
Uses the command-line client for the Zanata API (version 2). See L<Zanata CLI|http://docs.zanata.org/en/release/client/>.
